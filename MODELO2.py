...
def solucion_numerica(N, PeC, DaC, CA0, Win):
    ...
    # ---------------------------------------------------------------------------------------------------------------------------------
    # Nodo i = 1 => a_menos W_0 + a_0 W_1 + a_mas W_2 = -DaC CA0 dx => (usando W_0=Win) a_0 W_1 + a_mas W_2 = -DaC CA0 dx - a_menos Win
    # ---------------------------------------------------------------------------------------------------------------------------------
    ...
    # ---------------------------------------------------------------------------------------------------------------------------------------------------
    # Nodo i = N => a_menos W_{N-1} + a_0 W_N + a_mas W_{N+1} = -DaC CA0 dx => (usando W_{N-1}=W_{N+1}) (a_menos + a_mas)W_{N-1} + a_0 W_N = -DaC CA0 dx 
    # ---------------------------------------------------------------------------------------------------------------------------------------------------
